...
WebUI.setText(findTestObject('Object Repository/Folder 1/Page_Counterparty Limit Monitoring/input_COUNTERPARTY_NAME_GridVi'), 
    GlobalVariable.CPName)

WebUI.delay(2)


WebUI.click(findTestObject('Object Repository/Folder 1/Page_Counterparty Limit Monitoring/input_COUNTERPARTY_NAME_GridVi_1'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Folder 1/Page_Counterparty Limit Monitoring/span_EMBER COUNTER PARTY'))
...
WebUI.setText(findTestObject('Object Repository/Folder 1/Page_Counterparty Limit Monitoring/Page_Counterparty Limit Monitoring/textarea_Maker Remark_ctl00Mai'), 
    'Ok Remark entered by Maker')

WebUI.delay(2)

WebUI.selectOptionByValue(findTestObject('Object Repository/Folder 1/Page_Counterparty Limit Monitoring/Page_Counterparty Limit Monitoring/select_--SELECT--INDIASINGAPOR'), 
    'IN', true)

WebUI.delay(2)

WebUI.setText(findTestObject('Object Repository/Folder 1/Page_Counterparty Limit Monitoring/Page_Counterparty Limit Monitoring/input_CREDIT LIMITS_ctl00MainC'), 
    '10')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Folder 1/Page_Counterparty Limit Monitoring/Page_Counterparty Limit Monitoring/select_--SELECT--INDIASINGAPOR_1'), 
    'IN', true)

WebUI.delay(2)

WebUI.setText(findTestObject('Folder 1/Page_Counterparty Limit Monitoring/Page_Counterparty Limit Monitoring/input_T-LOC LIMITS_ctl00MainCo'), 
    '10')

WebUI.sendKeys(findTestObject('Folder 1/Page_Counterparty Limit Monitoring/Page_Counterparty Limit Monitoring/input_T-LOC LIMITS_ctl00MainCo'), 
    Keys.chord(Keys.TAB))
