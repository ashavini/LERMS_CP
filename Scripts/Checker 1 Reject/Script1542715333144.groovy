...
WebUI.takeScreenshot("C:\\Users\\ashavini\\Desktop\\Katalon\\Ankita\\Automation Project\\LERMS_Counterparty\\Screenshots\\Checker1_Recorddetails.png");
...
WebUI.setText(findTestObject('Checker 1 Forms Objects/Page_Counterparty Limit Monitoring/Reject Actions Obj/Page_Counterparty Limit Monitoring/textarea__ctl00MainContenttxtR'), 
    'Rejected by checker 2 ')

WebUI.delay(2)

WebUI.click(findTestObject('Checker 1 Forms Objects/Page_Counterparty Limit Monitoring/Reject Actions Obj/Page_Counterparty Limit Monitoring/input_()Mandatory Fields_ctl00'))
...
WebUI.verifyMatch(alertText,'Record rejected successfully by Checker1', false)
